...
def count_or_append_types(type_element: str, cnv_types_dict: dict[str, int]) -> dict[str, int]:
...
def iterate_sv_info(info_sv: list[dict[str, Any]], element_type: str) -> dict[str, int]:
    cnv_types_dict: dict[str, int] = {}
    for doc in info_sv:
